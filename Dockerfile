...
# NMS params for the live /detect loop (resolved per-request by config_resolver;
# the request payload can still override conf/img_size for HSE profiles).
ENV YOLO26_IOU="0.45"
ENV YOLO26_MAX_DETECTIONS="300"
