...
REASONER_TRIGGER_LEVEL=ORANGE
REASONER_MIN_INTERVAL_MS=5000
...
| `reasoner_status:timeout` | VLM slower than `REASONER_TIMEOUT_MS` | raise the timeout or reduce `REASONER_MAX_IMAGE_SIDE`; `/detect` is unaffected |
